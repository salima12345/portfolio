                ...
                <div className='grid grid-cols-1 md:grid-col-2 gap-[3rem] items-center'>
                    <div>
                        ...
                        <div className='flex items-center gap-3'>
                            <Link href="/images/ELKHALIDICv.pdf" download="Salima_El_Khalidi_CV" className='text-[#8750F7] py-3 px-8 border border-[#8750F7] rounded-3xl hover:bg-[#8750F7] hover:text-white transition-all font-medium'>
                                Download CV
                            </Link>
