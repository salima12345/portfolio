  ...
  return (
    <div ref={ref} className='flex flex-col lg:flex-row shadow-lg mb-10 px-1 space-y-4 lg:space-y-0 lg:space-x-4'>
      ...
      >
        ...
        <p className='text-white mb-10'>{project.projectDesc}</p>
        <Link href={project.projectLink} target='_blank' rel='noopener noreferrer'>
          <button className='text-[#8750F7] py-3 px-8 border border-[#8750F7] rounded-3xl hover:bg-[#8750F7] hover:text-white transition-all font-medium'>
            Check it out
          </button>
        </Link>
      </motion.div>
